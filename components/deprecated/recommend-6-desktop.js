...
import './recommend-6-desktop.scss'
    ...
    render() {
        ...
        return (fecthData.length > 0 &&
            <>
                ...
                <div className='recommend-6-desktop has-text-right'>
                    <div className={`columns is-mobile has-text-left ${multiline && 'is-multiline'}`} >
                        {
                            fecthData.map(
                                (item, index) =>
                                    <div className='column is-one-sixth-desktop is-half-mobile' key={item.ID} alt={item.Name}>
